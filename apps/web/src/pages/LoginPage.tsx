...
export function LoginPage() {
  ...
  async function handleMagicLinkSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t('auth.magicLink.error'));
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-bold mb-8 text-center">{getTitle()}</h1>
        ...
        {authMode === 'password' && (
          <>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition disabled:opacity-50 flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              className="w-full mt-4 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition text-gray-700 dark:text-gray-300"
            >
            ...
            <>
              ...
              <form onSubmit={handleMagicLinkSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition disabled:opacity-50"
                >
                  {loading ? t('auth.magicLink.sending') : t('auth.magicLink.sendLink')}
                </button>
              </form>
